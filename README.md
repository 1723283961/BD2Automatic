...
> 由于操作没有打包可以自定义魔改，使用者可能需要熟悉java语言
> 也可联系我打包处理调试

### 使用方式（仅支持PC端）
> 1.需要安装java环境:java17（打包成exe不需要jdk）
> 
> 2.使用时需要打开装备界面，点击进入需要选中需要一键分解的装备，对装备进行设置
> 
> 3.设置成全屏（我的是1920 * 1080) ，如果识别不到自己替换即可，替换路径
...
> 
>  说明：先进入装备选择，选择装备（建议是最低级的），在进入装备选择强化等级等(等级建议4级)，在返回装备页面启动脚本即可（第二个也图片的界面）


### 功能一览
* [X] 装备自动合成分解（刷粉，需要自己掉调节等级）
* [ ] 末日之书自动刷分
* [ ] 自动跑图
